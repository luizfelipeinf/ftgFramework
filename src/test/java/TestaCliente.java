...
public class TestaCliente {
    ...
    public void quandoRequisitarListaClientesSemAdicionar_EntaoElaDeveEstarVazia() {
        ...
        apagaTodosClientesDoServidor();
           ...
           clienteController.pegaTodosClientes(SERVICO_CLIENTE)
                .statusCode(HttpStatus.SC_OK)
                .body(equalTo(LISTA_CLIENTES_VAZIA));
    }

    @Test
    @DisplayName("Quando eu cadastrar um cliente, Entao ele deve ser salvo com sucesso")
    public void quandoCadastrarCliente_EntaoEleDeveSerSalvoComSucesso() {

        Cliente clienteParaCadastrar = new Cliente("Luiz", 31,10101 );

        clienteController.postaCliente(clienteParaCadastrar,SERVICO_CLIENTE,RECURSO_CLIENTE)
                .statusCode(HttpStatus.SC_CREATED)
                .body("10101.nome", equalTo("Luiz"))
    ...
    public void quandoAtualizarCliente_EntaoEleDeveSerAtualizadoComSucesso() {
        ...
        clienteController.atualizaCliente(clienteParaCadastrar,SERVICO_CLIENTE,RECURSO_CLIENTE)
                .statusCode(HttpStatus.SC_OK)
    ...
    public void quandoDeletarCliente_EntaoEleDeveSerDeletadoComSucesso() {
        ...
        // Act
        clienteController.postaCliente(cliente,SERVICO_CLIENTE,RECURSO_CLIENTE);

        // Act/Assert
        clienteController.apagaCliente(cliente,SERVICO_CLIENTE,RECURSO_CLIENTE)
                .statusCode(HttpStatus.SC_OK)
